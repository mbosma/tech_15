...
/**
 * USAGE:
 * 1 - To use this file replace "tech_15" with the name of
...
// Replace 'tech_15' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function tech_15_form_system_theme_settings_alter(&$form, &$form_state)  {
